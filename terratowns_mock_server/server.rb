...
class TerraTownsMockServer < Sinatra::Base
  ...
  def find_user_by_bearer_token
    ...
    # if we can't find it than return an error or if it doesn't match
    ...
    # was there a user_uuid in the body palyload json?
  ...
  post '/api/u/:user_uuid/homes' do
    ...
    begin
      ...
      # like rails so we need to parse it manually.
    ...
    # ensure our validation checks pass otherwise return 
    # the errors
    unless home.valid?
      # return the erros message back json
  ...
  get '/api/u/:user_uuid/homes/:uuid' do
    ...
    content_type :json
    # does the uuid match the one we have in our mock database?
